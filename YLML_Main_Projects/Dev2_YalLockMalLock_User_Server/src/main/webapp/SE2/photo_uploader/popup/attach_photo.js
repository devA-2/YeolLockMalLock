...
//    	sUploadURL= 'file_uploader_html5.php'; 	//upload URL
    	sUploadURL= '/Dev2_YalLockMalLock_User_Server/SE2/photo_uploader/popup/file_uploader_html5.jsp'; 	//upload URL
...
// 	        sCallback : location.href.replace(/\/[^\/]*$/, '') + '/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
 			sUrl: '/Dev2_YalLockMalLock_User_Server/SE2/photo_uploader/popup/file_uploader.jsp',
 			sCallback: '/Dev2_YalLockMalLock_User_Server/SE2/photo_uploader/popup/callback.html',
