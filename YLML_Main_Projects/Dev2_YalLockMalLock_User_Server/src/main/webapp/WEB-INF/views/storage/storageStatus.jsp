  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
      ...
      <div class="modal-content">
        ...
        <pre class="docu">	제1조(목적) 이 약관은 열락말락 주식회사(이하 “당사”라 합니다)와
...
말합니다.
3. “경과품”이란 보관일로부터  지하철 역 종료시간이상 경과한 보관품을 말합니다.
4. “유실물센터(이하 ”센터“라 합니다)”란 보관함 이용자의 편의증진을
위하여 사용방법 안내, 민원사항 처리 등의 업무를 수행하는 장소를 말합니다.

제3조(계약의 성립) ① 보관함 이용자와 당사와의 계약은 다음 각 호의 경우에 성립되며, 
이 경우 이용자는이 약관의 내용 및 이 약관을 근거로 정한 내용에 동의한 것으로 봅니다.
1. 이용요금 선불인 경우: 결제 후 해당 보관함에 물품을 보관 후 닫은 때
2. 이용요금 후불인 경우 : 이용자가 보관함에 물품을 보관 후, NFC를 이용하여 결제할 때
