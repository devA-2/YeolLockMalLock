...
<body>
	...
	<div id="container">
		...
		<form method="post" name="loginFrm">
			<div>아이디</div>
				<input type="text" name="email" id="email" required="required" value="jamza2@naver.com"/>
			<div>비밀번호</div>
				<input type="password" name="pw" id="pw" required="required" value="Asd2313532@" maxlength="20" size="20"><br>
