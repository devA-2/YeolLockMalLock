...
public class SampleController {
	...
	public Map<String, Object> sampleData(@RequestBody Map<String, Object> map){
		return service.getSampleData(map);
	}
	...
	public Map<String, Object> sampleDataTest(){
		...
		map.put("key", "1234");
		mapData.put("id", "wntjd337@gmail.com");
		mapData.put("pw", "1234");
		//TODO mapData to String
		ObjectMapper mapper = new ObjectMapper();

		try {
			String dataStr = mapper.writeValueAsString(mapData);
			map.put("data", dataStr);
			map.put("className", mapData.getClass().getName());
